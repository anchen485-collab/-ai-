...
"""Question-answering orchestration for the assistant."""
...
def recommendations(question: str) -> list[dict[str, str]]:
    """Match simple business keywords to next-step cards."""
...
def fallback_answer(question: str, hits: list[SearchHit]) -> str:
    """Show retrieved evidence when no LLM answer is available."""
